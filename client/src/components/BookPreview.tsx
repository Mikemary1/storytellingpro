      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="font-playfair text-4xl md:text-5xl font-bold text-navy mb-6">
            A Taste of <span className="text-gold">the Journey</span>
          </h2>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="mb-8">
              <h3 className="font-playfair text-3xl font-bold text-navy mb-4">Introduction</h3>
            ...
            <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-6">
              ...
              <motion.blockquote 
                className="border-l-4 border-gold pl-6 bg-gold bg-opacity-5 py-4 rounded-r-lg my-8"
              ...
              <motion.blockquote 
                className="border-l-4 border-navy pl-6 bg-navy bg-opacity-5 py-4 rounded-r-lg my-8"
                initial={{ opacity: 0, x: -20 }}
                animate={isInView ? { opacity: 1, x: 0 } : { opacity: 0, x: -20 }}
            ...
            >
              <p className="text-gray-600 mb-6 text-lg">
                Ready to transform your practice through storytelling?
              </p>
              <motion.button
